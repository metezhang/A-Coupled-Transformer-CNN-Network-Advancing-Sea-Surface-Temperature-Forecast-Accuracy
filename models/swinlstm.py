...
class PatchInflated(nn.Module):
    ...
    def __init__(self, in_chans, embed_dim, input_resolution, stride=4, padding=0, output_padding=0):
...
class UpSample(nn.Module):
    def __init__(self, img_size, patch_size, in_chans, embed_dim, depths_upsample, num_heads, window_size, mlp_ratio=4.,
        ...
        self.up_final = FinalPatchExpand_X4(input_resolution=patches_resolution,dim_scale=4,dim=embed_dim)
